...
} from "../../services/productService"; // Nhớ import hàm từ Service để thực thi get api bằng redux
...
export const fetchTopProducts = () => {
  return async (dispatch, getState) => {
    try {
      let res = await getTopProductsService(6);
      if (res && res.errCode === 0) {
        dispatch({
      ...
      console.log("FETCH_TOP_PRODUCTS_FAILED: ", e);
      dispatch({
        type: actionTypes.FETCH_TOP_PRODUCTS_FAILED,
      });
    }
